hii i'm rayne. I'm a high schooler in the Pacific Northwest and have been programming for nine years. I use a DELL Inspiron 15 3535 laptop running Arch Linux.

I'm a full-stack web developer who likes taking on ambitious projects and pushing my limits. My current hyperfixation is [Weathercord](https://github.com/raynecloudy/weathercord), an instant messaging app made to look pretty and be super customizable! Another project I've been working on for the past two years is my own web development IDE, called [Nekomide](https://github.com/nekomide). You can refer to the "Organizations" section on the left for a list of more interesting things I'm involved in.
